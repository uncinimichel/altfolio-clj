...
var or__28289__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj35091 = {"detail":data};
return obj35091;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__28277__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__28277__auto__)){
var and__28277__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__35098 = cljs.core._EQ_;
var expr__35099 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35098.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35099))){
return ((function (pred__35098,expr__35099){
return (function (p1__35092_SHARP_){
return console.warn(p1__35092_SHARP_);
});
;})(pred__35098,expr__35099))
} else {
if(cljs.core.truth_(pred__35098.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35099))){
return ((function (pred__35098,expr__35099){
return (function (p1__35093_SHARP_){
return console.debug(p1__35093_SHARP_);
});
;})(pred__35098,expr__35099))
} else {
if(cljs.core.truth_(pred__35098.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35099))){
return ((function (pred__35098,expr__35099){
return (function (p1__35094_SHARP_){
return console.error(p1__35094_SHARP_);
});
;})(pred__35098,expr__35099))
} else {
return ((function (pred__35098,expr__35099){
return (function (p1__35095_SHARP_){
return console.log(p1__35095_SHARP_);
});
;})(pred__35098,expr__35099))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35102){
...
var eval_fn = cljs.core.get.call(null,map__35103__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35105_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__35107,(0),null);
...
if(cljs.core.truth_((function (){var and__28277__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1512749442946
