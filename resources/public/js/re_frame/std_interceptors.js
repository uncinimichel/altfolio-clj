...
var vec__37518_37521 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_37522 = cljs.core.nth.call(null,vec__37518_37521,(0),null);
var only_after_37523 = cljs.core.nth.call(null,vec__37518_37521,(1),null);
var db_changed_QMARK__37524 = (!((only_before_37522 == null))) || (!((only_after_37523 == null)));
if(db_changed_QMARK__37524){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_37522);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_37523);
...
var map__37525 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__37525__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__37525__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__37527 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__37527__$1;
var event = cljs.core.get.call(null,map__37527__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__29459__auto___37530 = arguments.length;
var i__29460__auto___37531 = (0);
while(true){
if((i__29460__auto___37531 < len__29459__auto___37530)){
args__29466__auto__.push((arguments[i__29460__auto___37531]));

var G__37532 = (i__29460__auto___37531 + (1));
i__29460__auto___37531 = G__37532;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__29467__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq37529){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq37529));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__28289__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__29466__auto__ = [];
var len__29459__auto___37538 = arguments.length;
var i__29460__auto___37539 = (0);
while(true){
if((i__29460__auto___37539 < len__29459__auto___37538)){
args__29466__auto__.push((arguments[i__29460__auto___37539]));

var G__37540 = (i__29460__auto___37539 + (1));
i__29460__auto___37539 = G__37540;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__29467__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__37533_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__37534_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__37534_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__28277__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq37535){
var G__37536 = cljs.core.first.call(null,seq37535);
var seq37535__$1 = cljs.core.next.call(null,seq37535);
var G__37537 = cljs.core.first.call(null,seq37535__$1);
var seq37535__$2 = cljs.core.next.call(null,seq37535__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__37536,G__37537,seq37535__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1512749445953
