...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__30717 = cljs.core.instance_QMARK_;
var expr__30718 = reactive_val;
if(cljs.core.truth_(pred__30717.call(null,reagent.ratom.RAtom,expr__30718))){
return "ra";
} else {
if(cljs.core.truth_(pred__30717.call(null,reagent.ratom.RCursor,expr__30718))){
return "rc";
} else {
if(cljs.core.truth_(pred__30717.call(null,reagent.ratom.Reaction,expr__30718))){
return "rx";
} else {
if(cljs.core.truth_(pred__30717.call(null,reagent.ratom.Track,expr__30718))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1512749438373
