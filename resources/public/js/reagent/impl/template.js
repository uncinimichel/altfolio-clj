...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__28914__auto__,writer__28915__auto__,opt__28916__auto__){
return cljs.core._write.call(null,writer__28915__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__30569 = o;
(G__30569[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__30571__i < G__30571__a.length) {G__30571__a[G__30571__i] = arguments[G__30571__i + 0]; ++G__30571__i;}
  args = new cljs.core.IndexedSeq(G__30571__a,0,null);
} 
...
if(cljs.core.truth_((function (){var and__28277__auto__ = !((jsprops == null));
if(and__28277__auto__){
var and__28277__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__30575 = jsprops;
(G__30575["defaultValue"] = value);

(G__30575["onChange"] = ((function (G__30575,v,value,on_change){
return (function (p1__30574_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__30574_SHARP_);
});})(G__30575,v,value,on_change))
);
...
var vec__30578 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__30578,(0),null);
var id = cljs.core.nth.call(null,vec__30578,(1),null);
var class$ = cljs.core.nth.call(null,vec__30578,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___30582 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___30582 == null)){
} else {
var key_30583 = temp__4661__auto___30582;
(jsprops["key"] = key_30583);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__30584 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__30584["name"] = c);
...
var len__29459__auto___30589 = arguments.length;
var i__29460__auto___30590 = (0);
while(true){
if((i__29460__auto___30590 < len__29459__auto___30589)){
args__29466__auto__.push((arguments[i__29460__auto___30590]));

var G__30591 = (i__29460__auto___30590 + (1));
i__29460__auto___30590 = G__30591;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29467__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq30587){
var G__30588 = cljs.core.first.call(null,seq30587);
var seq30587__$1 = cljs.core.next.call(null,seq30587);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__30588,seq30587__$1);
});
...
break;
default:
var G__30594 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__30594;
continue;
...
var n__29235__auto___30596 = a.length;
var i_30597 = (0);
while(true){
if((i_30597 < n__29235__auto___30596)){
(a[i_30597] = reagent.impl.template.as_element.call(null,(a[i_30597])));

var G__30598 = (i_30597 + (1));
i_30597 = G__30598;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__29235__auto___30599 = a.length;
var i_30600 = (0);
while(true){
if((i_30600 < n__29235__auto___30599)){
var val_30601 = (a[i_30600]);
if((cljs.core.vector_QMARK_.call(null,val_30601)) && ((reagent.impl.template.key_from_vec.call(null,val_30601) == null))){
(o["no-key"] = true);
} else {
}

(a[i_30600] = reagent.impl.template.as_element.call(null,val_30601));

var G__30602 = (i_30600 + (1));
i_30600 = G__30602;
continue;
} else {
}
...
var ctx = ({});
var vec__30603 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__30603,(0),null);
var derefed = cljs.core.nth.call(null,vec__30603,(1),null);
...
var G__30606 = (cljs.core.count.call(null,argv) - first_child);
switch (G__30606) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__30606){
...
//# sourceMappingURL=template.js.map?rel=1512749438133
